...
def predictDisease(symptoms):
    ...
    data_dict = {'symptom_index': {'Itching': 0, 'Skin Rash': 1, 'Nodal Skin Eruptions': 2, 'Continuous Sneezing': 3,
                 ...
                 'predictions_classes': ['(vertigo) Paroymsal  Positional Vertigo', 'Fever', 'Acne',
...
if __name__=="__main__":
    pd = predictDisease(input('enter the symptoms:'))
    print(f'Disease:{pd["final_prediction"]}')
    print(f'Medicine:{pd["medicine"]}')